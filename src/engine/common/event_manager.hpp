...
public:
    ...
    void bindBoolToKey(bool& boolean, sf::Keyboard::Key key)
    {
        addKeyPressedCallback(key, [&](sfev::CstEv) { boolean = true; });
        addKeyReleasedCallback(key, [&](sfev::CstEv) { boolean = false; });
    }

    void bindBoolToMouseButton(bool& boolean, sf::Mouse::Button button)
    {
        addMousePressedCallback(button, [&](sfev::CstEv) { boolean = true; });
        addMouseReleasedCallback(button, [&](sfev::CstEv) { boolean = false; });
    }
